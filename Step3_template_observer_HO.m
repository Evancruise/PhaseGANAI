...
switch image_type
    case 'SKE'
        ...
        filenames = [data_dir,data_phi_dir,sprintf('cov_phi1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        filenameb = [data_dir,data_phi_dir,sprintf('cov_phi1%db_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)];
        filename1 = [data_dir,data_phi_dir,sprintf('KP1%dinv_%04g_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        ...
        fid=fopen([data_dir,data_phi_dir,sprintf('phi1%d_b_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)],'rb'); 
        phi12b=fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid); 
        phi12b=reshape(phi12b,[RAYS,RAYS,No_realizations]);
        
        fid=fopen([data_dir,data_phi_dir,sprintf('phi1%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb');
        ...
        filenameb = [data_dir,data_b_dir,sprintf('cov_b1%db_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)];
        filenames = [data_dir,data_b_dir,sprintf('cov_b1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        filename1 = [data_dir,data_b_dir,sprintf('KA1%dinv_%04g_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        ...
        fid=fopen([data_dir,data_b_dir,sprintf('b1%d_b_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)],'rb'); 
        b12b=fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid); 
        b12b=reshape(b12b,[RAYS,RAYS,No_realizations]);
        
        fid=fopen([data_dir,data_b_dir,sprintf('b1%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); 
        ...
        filenameb = [data_dir,data_phib_dir,sprintf('cov_phib1%db_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)];
        filenames = [data_dir,data_phib_dir,sprintf('cov_phib1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        filename1 = [data_dir,data_phib_dir,sprintf('KPA1%dinv_%04g_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        ...
        filenameb=[data_dir,data_I_dir,sprintf('cov_I%db_%04g_H0_BKS_%s.dat',det1,sigma0,recon_alg)];
        filenames=[data_dir,data_I_dir,sprintf('cov_I%ds_%04g_H1_%s_%s.dat',det1,sigma0,image_type,recon_alg)];
        filename1=[data_dir,data_I_dir,sprintf('KI%dinv_%04g_%s_%s.dat',det1,sigma0,image_type,recon_alg)];
        ...
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_b_%04g_H0_BKS_%s.dat',det1,sigma0,recon_alg)],'rb'); 
        I1b=fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid); 
        I1b=reshape(I1b,[RAYS,RAYS,No_realizations]);
        
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_s_%04g_H1_%s_%s.dat',det1,sigma0,image_type,recon_alg)],'rb');
        ...
        filenameb=[data_dir,data_I_dir,sprintf('cov_I%db_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)];
        filenames=[data_dir,data_I_dir,sprintf('cov_I%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        filename1=[data_dir,data_I_dir,sprintf('KI%dinv_%04g_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        ...
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_b_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)],'rb'); 
        I2b=fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid); 
        I2b=reshape(I2b,[RAYS,RAYS,No_realizations]);
        
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb');
        ...
        filenameb=[data_dir,data_I_dir,sprintf('cov_I1%db_%04g_H0_BKS_%s.dat',det2,sigma0,recon_alg)];
        filenames=[data_dir,data_I_dir,sprintf('cov_I1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
        filename1=[data_dir,data_I_dir,sprintf('KI1%dinv_%04g_%s_%s.dat',det2,sigma0,image_type,recon_alg)];
...
save([data_dir,sprintf('T_%d%d_%04g_%s_%s.mat',det1,det2,sigma0,image_type,recon_alg)],'T_s','T_b'); % save T
save([data_dir,sprintf('ROC_%d%d_%04g_%s_%s.mat',det1,det2,sigma0,image_type,recon_alg)],'TPF','FPF'); % save T
save([data_dir,sprintf('SNR2_%d%d_%04g_%s_%s.mat',det1,det2,sigma0,image_type,recon_alg)],'SNR2*'); % save T
save([data_dir,sprintf('AUC_%d%d_%04g_%s_%s.mat',det1,det2,sigma0,image_type,recon_alg)],'AUC*'); % save AUC
...
saveas(gcf,['ROC_curve_detector_pairs(',num2str(det1),',',num2str(det2),')_',image_type,'.png']);
print('-depsc',['ROC_curve_detector_pairs(',num2str(det1),',',num2str(det2),')_',image_type,'.eps']);
