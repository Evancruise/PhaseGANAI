...
%function Step3_CalculateCovofRealizations(data_dir,det,image_type)
...
switch image_type
    case 'BKS'
        ...
        fid=fopen([data_dir,data_phi_dir,sprintf('phi1%d_b_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); phi12b = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
        fid=fopen([data_dir,data_b_dir,sprintf('b1%d_b_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); b12b = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
        ...
        fid=fopen([data_dir,data_phi_dir,sprintf('cov_phi1%db_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid, eval(sprintf('cov_phi1%db',det2)),'double');
        fclose(fid); clear cov_phi12b
        fid=fopen([data_dir,data_b_dir,sprintf('cov_b1%db_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid, eval(sprintf('cov_b1%db',det2)),'double');
        fclose(fid); clear cov_b12b
        fid=fopen([data_dir,data_phib_dir,sprintf('cov_phib1%db_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid, eval(sprintf('cov_phib1%db',det2)),'double');
        fclose(fid); clear cov_phib12b

        fid=fopen([data_dir,data_I_dir,sprintf('I%d_b_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); I1b = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_b_%04g_H0_%s_%s.dat',det1,sigma0,image_type,recon_alg)],'rb'); I2b = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
        ...
        fid=fopen([data_dir,data_I_dir,sprintf('cov_I%db_%04g_H0_%s_%s.dat',det1,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid,eval(sprintf('cov_I%db',det1)),'double'); 
        fclose(fid); clear cov_I1b
        fid=fopen([data_dir,data_I_dir,sprintf('cov_I%db_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid,eval(sprintf('cov_I%db',det2)),'double'); 
        fclose(fid); clear cov_I2b
        fid=fopen([data_dir,data_I_dir,sprintf('cov_I1%db_%04g_H0_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
    ...
    case 'SKE'
        ...
        fid=fopen([data_dir,data_phi_dir,sprintf('phi1%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); phi12s = fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid);
        fid=fopen([data_dir,data_b_dir,sprintf('b1%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); b12s = fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid);
        ...
        fid=fopen([data_dir,data_phi_dir,sprintf('cov_phi1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid, eval(sprintf('cov_phi1%ds',det2)),'double');
        fclose(fid); clear cov_phi12s
        fid=fopen([data_dir,data_b_dir,sprintf('cov_b1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid, eval(sprintf('cov_b1%ds',det2)),'double');
        fclose(fid); clear cov_b12s
        fid=fopen([data_dir,data_phib_dir,sprintf('cov_phib1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid, eval(sprintf('cov_phib1%ds',det2)),'double');
        fclose(fid); clear cov_phib12s
        
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); I1s = fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid);
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_s_%04g_H1_%s_%s.dat',det1,sigma0,image_type,recon_alg)],'rb'); I2s = fread(fid,[RAYS*RAYS,No_realizations],'double'); fclose(fid);
        ...
        fid=fopen([data_dir,data_I_dir,sprintf('cov_I%ds_%04g_H1_%s_%s.dat',det1,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid,eval(sprintf('cov_I%ds',det1)),'double'); 
        fclose(fid); clear cov_I1s
        fid=fopen([data_dir,data_I_dir,sprintf('cov_I%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
        fwrite(fid,eval(sprintf('cov_I%ds',det2)),'double'); 
        fclose(fid); clear cov_I2s
        fid=fopen([data_dir,data_I_dir,sprintf('cov_I1%ds_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'wb'); 
    ...
    case 'SKEs'
        ...
        fid=fopen([data_dir,data_phi_dir,sprintf('phi1%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); phi12s = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
        fid=fopen([data_dir,data_b_dir,sprintf('b1%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); b12s = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
        ...
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_s_%04g_H1_%s_%s.dat',det1,sigma0,image_type,recon_alg)],'rb'); I1s = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
        fid=fopen([data_dir,data_I_dir,sprintf('I%d_s_%04g_H1_%s_%s.dat',det2,sigma0,image_type,recon_alg)],'rb'); I2s = fread(fid,[RAYS*RAYS,No_signals*No_realizations],'double'); fclose(fid);
